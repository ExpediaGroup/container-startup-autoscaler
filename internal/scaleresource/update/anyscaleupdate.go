...
type anyScaleUpdate struct{}

func (a *anyScaleUpdate) setResources(
	pod *v1.Pod,
	...
	containerToMutate.Resources.Requests[resource] = requests
	containerToMutate.Resources.Limits[resource] = limits
