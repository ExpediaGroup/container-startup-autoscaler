...
//			configMockFunc: func(m *kubetest.MockContainerHelper) {
//				m.On("CurrentRequests", mock.Anything, mock.Anything, v1.ResourceCPU).
//					Return(kubetest.PodAnnotationCpuStartupQuantity, nil)
//				m.On("CurrentRequests", mock.Anything, mock.Anything, v1.ResourceMemory).
//					Return(kubetest.PodAnnotationMemoryStartupQuantity, nil)
//				m.On("CurrentLimits", mock.Anything, mock.Anything, v1.ResourceCPU).
//					Return(kubetest.PodAnnotationCpuStartupQuantity, nil)
//				m.On("CurrentLimits", mock.Anything, mock.Anything, v1.ResourceMemory).
//					Return(kubetest.PodAnnotationMemoryStartupQuantity, nil)
...
//					Return(kubetest.PodAnnotationMemoryStartupQuantity, nil)
//				m.On("Requests", mock.Anything, v1.ResourceCPU).
//					Return(kubetest.PodAnnotationCpuPostStartupRequestsQuantity, nil)
//				m.On("Requests", mock.Anything, v1.ResourceMemory).
//					Return(kubetest.PodAnnotationMemoryPostStartupRequestsQuantity, nil)
//				m.On("Limits", mock.Anything, v1.ResourceCPU).
//					Return(kubetest.PodAnnotationCpuPostStartupRequestsQuantity, nil)
//				m.On("Limits", mock.Anything, v1.ResourceMemory).
//					Return(kubetest.PodAnnotationMemoryPostStartupRequestsQuantity, nil)
...
//	m.On("Requests", mock.Anything, v1.ResourceCPU).Return(kubetest.PodAnnotationCpuUnknownQuantity)
//	m.On("Requests", mock.Anything, v1.ResourceMemory).Return(kubetest.PodAnnotationMemoryUnknownQuantity)
//	m.On("Limits", mock.Anything, v1.ResourceCPU).Return(kubetest.PodAnnotationCpuUnknownQuantity)
//	m.On("Limits", mock.Anything, v1.ResourceMemory).Return(kubetest.PodAnnotationMemoryUnknownQuantity)
//}
