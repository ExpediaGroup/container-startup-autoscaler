...
//			configHelperMockFunc:     func(m *kubetest.MockPodHelper) {},
...
//				kubetest.NewMockPodHelper(tt.configHelperMockFunc),
...
//	)
//	mockContainerHelper := kubetest.NewMockContainerHelper(func(m *kubetest.MockContainerHelper) {
//		m.GetDefault()
//		m.RequestsDefault()
//		m.LimitsDefault()
//	})
...
//		&record.FakeRecorder{},
//		configStatusMockFunc, nil, mockContainerHelper,
//	)
//
//	buffer := bytes.Buffer{}
...
//			kubetest.PodAnnotationCpuPostStartupRequestsQuantity.String(),
//			kubetest.PodAnnotationCpuPostStartupLimitsQuantity.String(),
//			kubetest.PodAnnotationMemoryPostStartupRequestsQuantity.String(),
//			kubetest.PodAnnotationMemoryPostStartupLimitsQuantity.String(),
//		)
