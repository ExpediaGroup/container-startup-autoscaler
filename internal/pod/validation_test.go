...
//		configHelperMockFunc      func(*podtest.MockPodHelper)
//		configContHelperMockFunc  func(*podtest.MockContainerHelper)
...
//			},
//			configHelperMockFunc: func(m *podtest.MockPodHelper) {
//				m.On("ExpectedLabelValueAs", mock.Anything, podcommon.LabelEnabled, podcommon.TypeBool).
//					Return(nil, errors.New(""))
//			},
//			configContHelperMockFunc:  func(m *podtest.MockContainerHelper) {},
...
//				podtest.NewMockPodHelper(tt.configHelperMockFunc),
//				podtest.NewMockContainerHelper(tt.configContHelperMockFunc),
//			)
